import {
  ...
  initTheme
} from '../server/src/includes/common-utils';
  ...
  describe('DOM Creation Functions', () => {
    describe('createButton', () => {
      test('should create button with correct properties', () => {
        ...
        const button = createButton('test-class', 'Test Text', 'Test Label', clickHandler);
      ...
      test('should attach click handler', () => {
        const clickHandler = jest.fn();
        const button = createButton('test-class', 'Test', 'Label', clickHandler);
  ...
  describe('Clipboard Operations', () => {
    describe('copyToClipboard', () => {
      ...
      test('should show alert when clipboard API is not available', () => {
        ...
        expect(window.alert).toHaveBeenCalledWith('Failed (Clipboard API not supported)');
      });
  ...
  describe('Theme Management', () => {
    ...
    describe('toggleTheme', () => {
      test('should toggle from light to dark', () => {
        ...
        expect(mockLocalStorage.setItem).toHaveBeenCalledWith('hakanai-theme', 'dark');
        expect(document.body.getAttribute('data-theme')).toBe('dark');
      });
      ...
      test('should toggle from dark to light', () => {
        ...
        expect(mockLocalStorage.setItem).toHaveBeenCalledWith('hakanai-theme', 'light');
        expect(document.body.getAttribute('data-theme')).toBe('light');
      });
