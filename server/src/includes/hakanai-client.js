...
class BrowserCompatibility {
    ...
    static getCompatibilityInfo() {
        ...
        const cryptoInstance = (window === null || window === void 0 ? void 0 : window.crypto) || crypto;
...
class HakanaiClient {
    constructor(baseUrl) {
        ...
        if (!compatibilityInfo.isCompatible) {
            throw new Error(`Your browser does not support the required security features for this application. ` +
